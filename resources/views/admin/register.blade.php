...
<head>
    ...
    <title>Abdulfortech |  Register</title>
                    ...
                    <div class="card-body p-0">
                        <div class="p-3">
                            <div class="text-center p-0">
                                ...
                                <h2 class="text-primary mt-4 font-weight-bold">Register</h2>
                            </div>
                            <form class="user mt-5" action="{{ route('adminRegister') }}" method="POST">
                            @csrf
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="name" placeholder="Your name" required autofocus>
                                    @if ($errors->has('name'))
